...
`kun-video-editor-0.4.3.kunx` asset beside the desktop installers and the three
...
```bash
kun extension validate ./kun-video-editor-0.4.3.kunx
kun extension install ./kun-video-editor-0.4.3.kunx
```
