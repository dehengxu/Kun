...
const SETTINGS_SECTIONS: ReadonlyArray<{
  ...
  { id: 'design', Component: DesignSettingsSection as (props: { ctx: Record<string, unknown> }) => ReactElement },
  ...
  { id: 'subagents', Component: SubagentsSettingsSection as unknown as (props: { ctx: Record<string, unknown> }) => ReactElement },
